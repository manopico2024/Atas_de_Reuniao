...
class AtasdeReuniao(TelaArrastavelBase):
    def __init__(self, parent=None):
        ...
        # Configurações da janela
        self.setWindowFlags(Qt.FramelessWindowHint)  # Remove bordas da janela
        self.setWindowIcon(QIcon("icons/icons/logoSpike.png"))
    ...
    def conectar_botoes(self):
        try:
            # BOTÕES PRINCIPAIS
            self.ui.BTN_BUSCAR_MEMBRO.clicked.connect(self.abrir_tela_buscar_membro)
    ...
    def configurar_shortcuts_principal(self):
        try:
            # F3 - Abrir tela de busca de membros
            self.shortcut_equipamentos = QShortcut(QKeySequence(Qt.Key_F3), self)
            self.shortcut_equipamentos.activated.connect(self.abrir_tela_buscar_membro)
    ...
    F3 - Tela de busca de membros por nome
    ...
    def abrir_tela_grafico_de_presenca(self):
        try:
            ...
            print("✅ Tela de gráfico aberta - pode ser arrastada separadamente!")
        except Exception as e:
            QMessageBox.critical(self, "Erro", 
    ...
    def abrir_tela_login(self):
        try:
            ...
            print("✅ Tela de login aberta - pode ser arrastada separadamente!")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if login.login_foi_bem_sucedido():
            ...
            print("💡 Dica: Abra outras telas (F3 Tela de busca de membros por nome), (F4 para gráfico), e arraste cada uma separadamente!")
